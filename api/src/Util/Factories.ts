        ...
        swaggerDefinition: {
            ...
            components: {
                ...
                schemas: {
                    ...
                    ReviewReaction: reviewReactionJsdocSchema,
                    Review: reviewJsdocSchema,
                    newReviewFromJsdocSchema: newReviewFromJsdocSchema,
                    User: userJsdocSchema,
                    userLoginJsdocSchema: userLoginJsdocSchema,
                    userSignUpJsdocSchema: userSignUpJsdocSchema,
                    userWalletLogInFrom: userWalletLogInFrom,
